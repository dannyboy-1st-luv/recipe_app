...
class CookbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cookbook" do
    assert_difference('Cookbook.count') do
      post cookbooks_url, params: { cookbook: { instruction: @cookbook.instruction, title: @cookbook.title } }
    end
  ...
  test "should update cookbook" do
    patch cookbook_url(@cookbook), params: { cookbook: { instruction: @cookbook.instruction, title: @cookbook.title } }
